        ...
        case APP_STATE_SCHEDULE_READ:
            ...
            if (appData.isReadComplete == true) {
                ...
                if (appData.readBuffer[0]=='1'){
                    ...
                    appData.readBuffer[0]='k';
                } else if (appData.readBuffer[0]=='2'){ 
                    if (OC1RS<900) {
                        OC1RS = OC1RS + 300;
                    } else {} 
                    appData.readBuffer[0]='k';
                } else if (appData.readBuffer[0]=='3'){
                    if (OC1RS>299) {
                        OC1RS = OC1RS - 300;
                    } else {}
                    appData.readBuffer[0]='k';
                } else if (appData.readBuffer[0]=='4'){
                    if (LATBbits.LATB3==0){
                        LATBbits.LATB3 = 1;
                    } else {
                        LATBbits.LATB3 = 0;
                    ...
                    appData.readBuffer[0]='k';
                } else if (appData.readBuffer[0]=='5'){
                    if (OC4RS<900) {
                        OC4RS = OC4RS + 300;
                    } else {}
                    appData.readBuffer[0]='k';
                } else if (appData.readBuffer[0]=='6'){
                    if (OC4RS>299) {
                        OC4RS = OC4RS - 300;
                    } else {}
                    appData.readBuffer[0]='k';
